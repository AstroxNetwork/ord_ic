...
// ------------------
// injected macros
use ord_canister_mod::state::*;
use ord_canister_mod::types::{Example, UserProfile, UserWallet};
...
#[pre_upgrade]
pub fn pre_upgrade() {
    ord_canister_mod::state::pre_upgrade()
}

#[post_upgrade]
pub fn post_upgrade() {
    ord_canister_mod::state::post_upgrade();
}
